...
![各属性指定颜色位置](image/android/firstcode/toolbar_anay.jpg)
...
![带action按钮的Toolbar](image/android/firstcode/toolbar_xiaoguo.jpg)
...
```
效果如下：
![NavigationView滑动菜单界面](image/blog/app/navigation_view.jpg)
...
![效果图](image/android/firstcode/coorlayout.jpg)
...
![fruit_effect](image/fruit_effct.gif)
