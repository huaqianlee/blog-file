...
![](image/linux/book/add_change.png)
<!--more-->
![](image/linux/book/addr_resolution.png)
...
分段机制、分页机制应用如下：
![](image/linux/book/vir_addr_map.png)

![](image/linux/book/line_phy.png)
...
每个进程代码在逻辑空间分布如下：
![](image/linux/book/progress_add.png)
