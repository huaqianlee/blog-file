...
<!--more-->　
![arch](image/blogandroidarchitecture.jpg)
　
当按下电源开关后，主要执行了如下步骤：
　
![boot](image/blogbootflow.png)
　
另，在内核启动了第一个进程后，init->home lanucher的详细流程如下：
　
![boot](image/blog0_1273850759wbAp.gif)
...
![from internet](image/blogZygote.jpg)
