...
![temp](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_1.png)

## 硬件架构

<!--more-->
![hw_arch](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_2.jpg)
硬件实现过冷过热检测停止充电：
![temp_monitor](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_3.png)

<!--more-->        
## 工作状态机
![bms_state](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_4.jpg)
## 软件架构
![sw_arch](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_5.jpg)
...
## 驱动架构分析
### Interface Mapping
![IM](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_6.jpg)
![IM](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_7.jpg)
### 几个主要的结构体
```bash
...
![probe](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_8.jpg)
```bash 
...
```
### 主线二: SoC work loop
![loop](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_9.jpg)
```bash        
         static void monitor_soc_work(struct work_struct *work)
...
### 主线三: Report  SoC
![report](https://github.com/huaqianlee/blog-file/image/android/qcom/bms_10.jpg)
```bash        
