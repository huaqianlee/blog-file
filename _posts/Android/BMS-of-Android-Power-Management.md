...
![state](image/android/mtk/chargind_state.jpg)
<!--more-->
## 充电简要流程框图

![flow](image/android/mtkGauge_arch.jpg)

# BMS 架构
MTK 的 BMS 架构如下：
![bms](image/android/mtk/battery%20introduction.jpg)
...
```
IPO方式流程图如下：
![IPO](image/android/mtk/power%20off%20charging.jpg)
...
![arch](image/android/mtk/kernel_cod_arch.jpg)
### 1.3.1 ADC部分
...
![FG&Charging Control](image/android/mtk/charging_control.jpg)
...
#### 正常开机
正常开机时电池信息更新：
![update_battery](image/android/mtk/bat_update_func.jpg)
...
![charging flow](image/android/mtk/power%20off%20charging2.jpg)
